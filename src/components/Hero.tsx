    ...
    <section id="hero" className="min-h-[80vh] flex flex-col justify-center pt-20 relative overflow-hidden">
      ...
      >
        ...
        <h2 className="text-xl md:text-2xl text-muted-foreground font-medium max-w-2xl">
          ...
          <span className="text-primary">·</span> Fontend{" "}
        ...
        <div className="flex flex-wrap items-center gap-3 pt-4">
          <Button asChild size="lg" className="font-bold rounded-full gap-2" data-testid="button-contact-email">
            <a href="mailto:niteeshpal801@gmail.com">
        ...
        <div className="flex flex-wrap items-center gap-5 pt-2">
          <a
            href="https://github.com/Niteesh-pal"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://www.linkedin.com/in/niteesh-pal/"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://leetcode.com/u/niteeshpal801/"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="tel:+917268802124"
            className="text-muted-foreground hover:text-foreground transition-colors"
            data-testid="link-phone"
            title="+91 726-880-2124"
          >
